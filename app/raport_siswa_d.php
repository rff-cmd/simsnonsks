<tbody>
	<tr>
		<th colspan="11">Kelompok C (Pilihan Lintas Peminatan)</th>
	</tr>
	<?php
		//$sql=$selectview->list_siswa_krs($datasiswa->nis, 4);
	...
	<tr>
		...
		<input type="hidden" name="kelompok_pelajaran_<?php echo $no ?>" id="kelompok_pelajaran_<?php echo $no ?>" class="form-control" value="4">
	</tr>
	<?php
			$no++;
		}
	...
	<input type="hidden" name="jmldata" id="jmldata" class="form-control" value="<?php echo $no ?>">
</tbody>