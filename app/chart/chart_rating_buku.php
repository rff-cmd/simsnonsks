...
while ($row_tingkat=$sql1->fetch(PDO::FETCH_OBJ)) {
	$sqlstr2 = "select count(a.kodepustaka) count_surat, month(a.tglpinjam), a.kodepustaka from pinjam a  group by a.kodepustaka having a.kodepustaka='$row_tingkat->kodepustaka'";
