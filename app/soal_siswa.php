	...
	<div class="row">
		<div class="col-xs-12">
            ...
            <?php 
				...
				if ($_POST['submit'] == 'Selesai') { $ref = ''; }
				//-----------------------------------------------/\
					
				include("app/exec/insert_soal_siswa.php");
				
				$tanggal = date("d-m-Y");
				if ($ref != "") {
					$sql=$select->list_soal_siswa($ref);
			...
			<!-- PAGE CONTENT BEGINS -->
			<form class="form-horizontal" role="form" action="" method="post" name="soal_siswa" id="soal_siswa" class="form-horizontal" enctype="multipart/form-data" onSubmit="return cekinput('tanggal,idsiswa,idsemester');" >
            	
            	<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right" for="form-field-1"><?php if($lng==1) { echo 'Date'; } else { echo 'Tanggal'; } ?> *)</label>
					<div class="col-sm-3">
						<input type="text" id="tanggal" name="tanggal" readonly="" class="form-control date-picker" data-date-format="dd-mm-yyyy" value="<?php echo $tanggal ?>">				
					</div>
				</div>
				...
				<div class="clearfix form-actions">
					<div class="col-md-offset-3 col-md-9">
                        ...
                        <?php if (allowadd('frmsoal_siswa')==1) { ?>
    						<?php if($ref=='') { ?>
    							<input type="submit" name="submit" id="submit" class='btn btn-primary' value="Selesai" onClick="return confirm('Apakah sudah yakin akan menjawab pertanyaan ini?')" />
    						<?php } ?>
                        <?php } ?>
						...
						&nbsp;
						<input type="button" name="submit" id="submit" class="btn btn-success" value="Hasil Test" onclick="self.location='<?php echo $nama_folder . '/' . obraxabrix(soal_siswa_view) ?>'" />
