...
?>		
		...
		<span class="input-icon">
			&nbsp;<input type="submit" id="submit_det" name="submit" class="btn btn-metis-2 btn-sm" style="height: 34px" value="Add Detail" onClick="return confirm('Apakah data sudah betul?')" >
