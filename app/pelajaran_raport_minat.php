	...
	<div class="row">
		<div class="col-xs-12">
            ...
            <?php 
				...
				include("app/exec/insert_pelajaran_raport_minat.php"); 
				
				if ($ref != "") {
					$sql=$select->list_pelajaran_raport_minat($ref);
					$row_pelajaran_raport_minat=$sql->fetch(PDO::FETCH_OBJ);							
				}		
			?>
            
			<!-- PAGE CONTENT BEGINS -->
			<form class="form-horizontal" action="" method="post" name="pelajaran_raport_minat" id="pelajaran_raport_minat" enctype="multipart/form-data" >
                ...
                <div class="form-group">
					...
					<div class="col-sm-3">
						<select name="pelajaran_id" id="pelajaran_id" class="chosen-select form-control" >
							<option value=""></option>
							<?php select_pelajaran("SMA", $row_pelajaran_raport_minat->pelajaran_id); ?>
						</select>
					</div>
				</div>
                ...
                <div class="form-group">
					...
					<div class="col-sm-3">
						<input type="text" id="urutan" name="urutan" class="form-control" onkeyup="formatangka('urutan')" value="<?php echo number_format($row_pelajaran_raport_minat->urutan,0,'.',',') ?>">
					</div>
				</div>
				...
				<div class="clearfix form-actions">
					<div class="col-md-offset-3 col-md-9">
                        ...
                        <?php if (allowadd('frmpelajaran_raport_minat')==1) { ?>
    						<?php if($ref=='') { ?>
    							<input type="submit" name="submit" id="submit" class='btn btn-primary' value="Simpan" />
    						<?php } ?>
                        <?php } ?>
                        
                        <?php if (allowdel('frmpelajaran_raport_minat')==1) { ?>
                            &nbsp;
...
<?php
	include("pelajaran_raport_minat_view.php");
?>
