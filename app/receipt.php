...
<script language="javascript">
	function cekinput(fid) {  
	  ...
	  if(deposit > 0) {
		alert('Balance tidak boleh > 0');
		
		return false;		
	  }
	  
	  if(deposit < 0) {
		alert('Balance tidak boleh minus');
...
<script type="text/javascript">
	function receip_history(invoice_no) {
		...
		window.open('<?php echo $__folder ?>app/receipt_history.php?invoice_no='+invoice_no, '','825','450','resizable=1,scrollbars=1,status=0,toolbar=0')
	}
</script>
...
<script language="javascript">
	function print() {
		...
		window.open('<?php echo $__folder ?>app/receipt_print.php?ref='+ref, '','825','450','resizable=1,scrollbars=1,status=0,toolbar=0')
	}
</script>
			...
			<input type="hidden" id="status" name="status" value="<?php echo $status ?>">	
            	...
            	<div class="row">
					<div class="col-sm-6">
						<div class="row">
							...
							<div class="form-group">
		                        <label class="col-sm-3 control-label no-padding-right">Tipe Bayar *)</label>
		                        <div class="col-sm-4">
		                        ...
		                        <?php if ($ref=='') { ?>
		                          <select id="client_code" name="client_code" data-placeholder="..." class="chosen-select form-control" style="width: auto" onChange="loadHTMLPost2('app/receipt_ajax.php','invoicedetail','getinvoice','client_code')">
		                            ...
		                            <?php 
										...
										select_siswa_id($row_receipt->client_code);
		                            ?>                   
		                          </select>
		                        <?php } else { ?>
				...
				<div class="clearfix form-actions">
					<div class="col-md-offset-3 col-md-9">
						...
						<input type="button" name="submit" id="submit" class="btn btn-success" value="List Data" onclick="self.location='<?php echo $folder__ . obraxabrix('receipt_view') ?>'" />
...
<![endif]-->
<script src="<?php echo $__folder ?><?php echo $__folder ?>assets/js/jquery-ui.custom.min.js"></script>
