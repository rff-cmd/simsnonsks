	...
	<div class="row">
		<div class="col-xs-12">
            ...
            <?php 
				...
				include("app/exec/insert_soal_select.php");
				
				if ($ref != "") {
					$sql=$select->list_soal_select($ref);
					$row_soal_select=$sql->fetch(PDO::FETCH_OBJ);	
					
					if ($row_soal_select->aktif == 1) {
						$act = "checked";
					} else {
						$act = "";
					}
			...
			<!-- PAGE CONTENT BEGINS -->
			<form class="form-horizontal" role="form" action="" method="post" name="soal_select" id="soal_select" class="form-horizontal" enctype="multipart/form-data" >
            	...
            	<div class="form-group">
					...
					<div class="col-sm-3">
						<select name="idtingkat" id="idtingkat" class="chosen-select form-control" onChange="loadHTMLPost2('app/soal_select_ajax.php','soal_select_detail','getsoal','idtingkat','idjurusan','idsemester')" >
							<option value=""></option>
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<select name="idjurusan" id="idjurusan" class="chosen-select form-control" onChange="loadHTMLPost2('app/soal_select_ajax.php','soal_select_detail','getsoal','idtingkat','idjurusan','idsemester')" >
							<option value=""></option>
                ...
                <div class="form-group">
					...
					<div class="col-lg-2">
						<select name="idsemester" id="idsemester" class="chosen-select form-control" onChange="loadHTMLPost2('app/soal_select_ajax.php','soal_select_detail','getsoal','idtingkat','idjurusan','idsemester')" >
							<option value=""></option>
            	...
            	<div id="soal_select_detail">
            		<?php
            			if( !empty($ref) ) {
							include("soal_select_detail_update.php");
						}
            		?>
            	</div>
				...
				<div class="clearfix form-actions">
					<div class="col-md-offset-3 col-md-9">
                        ...
                        <?php if (allowupd('frmsoal_select')==1) { ?>
                            <?php if($ref!='') { ?>
    							<input type="submit" name="submit" id="submit" class='btn btn-primary' value="Update" />
    						<?php } ?>
                        <?php } ?>
						
                        <?php if (allowadd('frmsoal_select')==1) { ?>
    						<?php if($ref=='') { ?>
    							<input type="submit" name="submit" id="submit" class='btn btn-primary' value="Simpan" />
    						<?php } ?>
                        <?php } ?>
                        
                        <?php /*if (allowdel('frmsoal_select')==1) { ?>
                            &nbsp;
						...
						&nbsp;
						<input type="button" name="submit" id="submit" class="btn btn-success" value="Preview Soal" onclick="self.location='<?php echo $nama_folder . '/' . obraxabrix(soal_select_view) ?>'" />
