							...
							<div class="form-group">
								...
								<div class="col-sm-5">
			        				...
			        				<?php if (!empty($row_surat_masuk->file_dokumen)) { ?>
			        					<a class="label label-success" href="/sman28/app/surat_masuk_download.php?ref=<?php echo $ref ?>" target="_blank" title="Download"><?php echo $row_surat_masuk->file_dokumen; ?>
										</a>
			        				<?php } ?>
