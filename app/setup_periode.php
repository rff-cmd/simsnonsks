	...
	<div class="row">
		<div class="col-xs-12">
            ...
            <?php 
				...
				include("app/exec/insert_setup_periode.php");
				...
				if ($ref != "") {
					$sql=$select->list_setup_periode($ref);
					$setup_periode_data=$sql->fetch(PDO::FETCH_OBJ);	
					
					$tanggal = date("d-m-Y", strtotime($setup_periode_data->tanggal));
					$tanggal1 = date("d-m-Y", strtotime($setup_periode_data->tanggal1));
					
					$aktif = "";
					if ($setup_periode_data->aktif == 1) {
						$aktif = "checked";
					} else {
						$aktif = "";
					}
			...
			<!-- PAGE CONTENT BEGINS -->
			<form class="form-horizontal" role="form" action="" method="post" name="setup_periode2" id="setup_periode2" class="form-horizontal" enctype="multipart/form-data" onSubmit="return cekinput('tanggal,tanggal1,jenis');" >
            	...
            	<div class="form-group">
					...
					<div class="col-lg-3">
						<select name="jenis" id="jenis" class="chosen-select form-control" >
							<option value=""></option>
							<?php select_jenis_periode($setup_periode_data->jenis); ?>
						</select>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<select name="tingkat_id" id="tingkat_id" class="chosen-select form-control" >
							<option value=""></option>
							<?php select_tingkat_unit("SMA", $setup_periode_data->tingkat_id); ?>
						</select>								
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<input type="text" id="tanggal" name="tanggal" style="font-size: 12px" class="form-control date-picker" data-date-format="dd-mm-yyyy" autocomplete="off" value="<?php echo $tanggal ?>">								
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<input type="text" id="tanggal1" name="tanggal1" style="font-size: 12px" class="form-control date-picker" data-date-format="dd-mm-yyyy" autocomplete="off" value="<?php echo $tanggal1 ?>">								
					</div>
				</div>
				...
				<div class="clearfix form-actions">
					<div class="col-md-offset-3 col-md-9">
                        ...
                        <?php if (allowadd('frmsetup_periode')==1) { ?>
    						<?php if($ref=='') { ?>
						...
						&nbsp;
						<input type="button" name="submit" id="submit" class="btn btn-success" value="List Data" onclick="self.location='<?php echo $nama_folder . '/' . obraxabrix('setup_periode_view') ?>'" />
