...
<div class="page-content">
	...
	<div class="row">
		<div class="col-xs-12">
			...
			<!-- PAGE CONTENT BEGINS -->
			<form class="form-horizontal" role="form" action="" method="post" name="kartu_rencana_studi" id="kartu_rencana_studi" enctype="multipart/form-data" onSubmit="return cekinput('idtahunajaran,tingkat_id,peminatan,semester_id,kelompok_pelajaran_id,pelajaran_id');" >
            	...
            	<div class="form-group">
					...
					<div class="col-sm-3">
						<select name="tingkat_id" id="tingkat_id" class="chosen-select form-control"onchange="loadHTMLPost3('<?php echo $__folder ?>app/kartu_rencana_studi_ajax.php', 'kode_id', 'getdata', 'peminatan', 'tingkat_id', 'kelompok_pelajaran_id', 'urutan')"  >
							<option value=""></option>
							<?php select_tingkat_unit("SMA", $row_kartu_rencana_studi->tingkat_id); ?>
						</select>
					</div>
				</div>
