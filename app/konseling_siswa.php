								...
								<div>
									...
									<table class="table" border="0" cellpadding="5">
										...
										<tr>
											...
											<td>:</td>
											<td>
												<select name="departemen" id="departemen" class="cho" style="width:100px;   font-size:12px; padding:0px; " onchange="loadHTMLPost2('app/konseling_siswa_ajax.php','idtingkat','gettingkat','departemen')" />
													<option value="">...</option>
										...
										<tr>
											...
											<td>:</td>
											<td>
												<select name="idtingkat" id="idtingkat" style="min-width: 178px; height:27px; font-size:12px; padding:0px; " onClick="loadHTMLPost2('app/konseling_siswa_ajax.php','idkelas','getkelas','idtingkat')" />
													<option value=""></option>
										...
										<tr>
											...
											<td>:</td>
											<td>
												<select name="idkelas" id="idkelas" style="min-width: 178px; height:27px; font-size:12px; padding:0px; " onClick="loadHTMLPost2('app/konseling_siswa_ajax.php','idsiswa','getsiswa','idkelas')" />
													<option value=""></option>
