...
<div class="page-content">
	...
	<div class="row">
		<div class="col-xs-12">
			...
			<!-- PAGE CONTENT BEGINS -->
			<form class="form-horizontal" role="form" action="<?php echo $nama_folder ?>/<?php echo obraxabrix('soal_ukbm_siswa_filter') ?>" method="post" name="soal_siswa" id="soal_siswa" class="form-horizontal" enctype="multipart/form-data" onSubmit="return cekinput('tanggal,idsiswa,idsemester,idukbm');" >
				...
				<div class="form-group">
					...
					<div class="col-lg-2">
						<select name="idsemester" id="idsemester" class="chosen-select form-control" >
							<option value=""></option>
							<?php select_semester("SMA", $row_soal_siswa->idsemester); ?>
						</select>
					</div>
				</div>
