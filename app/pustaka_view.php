...
<script type="text/javascript">
	...
	function import_pustaka() {	
		window.open('app/import_pustaka.php','Upload Data Pustaka','1000','500','resizable=1,scrollbars=1,status=0,toolbar=0');
	}
			...
			<div class="row">
				<div class="col-xs-12">
					...
					<form class="form-horizontal" role="form" action="" method="post" name="pegawai_lis" id="pegawai_list" enctype="multipart/form-data" >
		            	...
		            	<a href="<?php echo $__folder ?>app/pustaka_format_upload.php" target="_blank" class="btn btn-pink">
        					<i class="ace-icon fa fa-cloud-download"></i>
        					Download Format
        				</a>	

						&nbsp;&nbsp;
						<a href="#" class="btn btn-app btn-purple btn-sm" onClick="JavaScript:import_pustaka()">
