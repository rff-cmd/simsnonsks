...
$sql = $selectview->list_purchase_inv($ref);
...
/*---------print header-----------*/
$sqlunit = $selectview->list_identitas();
$dataunit = $sqlunit->fetch(PDO::FETCH_OBJ);
$company_name = $dataunit->nama;
$bussines_name = $dataunit->businiss_type;

$address = $dataunit->alamat1; //"Jl. Sample No. 21, Bandung";
$email = $dataunit->email; //"nadhif@programmer.net";
$phone = $dataunit->telp1; 
/*-------------------------------*/
...
$sql2 = $selectview->list_purchase_inv_detail($ref);
...
class PDF extends FPDF
{
	...
	function Header()
	{
		...
		$this->Image('../assets/img/logo.jpg', 12, 9, 20, 20, 'jpg', '');
		//$this->Ln(1);
	...
	function BasicTable($header,$data)
	{
		...
		$this->Cell(144,5,'',0,0,'L',false); //Terbilang :
		
		$this->Cell(25,5,'Sub Total',0,0,'R',false);
		$this->Cell(25,5,$sub_total,0,1,'R',false);
		
		$this->Cell(144,5,'',0,0,'L',true);	//$terbilang
		...
		*/
		...
		$this->Cell(48,5,'Petugas',0,1,'C',true);	
		$this->Ln(10);
