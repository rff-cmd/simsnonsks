...
<script language="javascript">
	function submitForm(tipe)
    {
		if(tipe == 'view') {
			...
			$("#rpt_varian").attr('action', 'app/rpt_varian_view.php')
			   .attr('target', '_BLANK');
			$("#rpt_varian").submit();
		}
...
<script type="text/javascript">
	function excel_export() {
		...
		document.location.href = "app/rpt_varian_xls.php?item_code="+item_code+"&location_id="+location_id+"&uom_code="+uom_code+"&all="+all+"&item_group_id="+item_group_id;	
	}
</script>
...
<div class="page-content">
    ...
    <div class="row">
		<div class="col-xs-12">
			...
			<form class="form-horizontal" role="form" action="" method="post" name="rpt_varian" id="rpt_varian" class="form-horizontal" enctype="multipart/form-data" >
				...
				<div class="form-group">
                    ...
                    <div class="col-sm-4">
                      <select id="vendor_code" name="vendor_code" data-placeholder="..." class="chosen-select form-control" style="width: auto" >
                        <option value=""></option>
                        <?php 
				...
				<div class="form-group">
                    <label class="col-sm-3 control-label no-padding-right">Lokasi/Gudang/Toko</label>
                    <div class="col-sm-4">
				...
				<div class="form-group">
                    <label class="col-sm-3 control-label no-padding-right">Kode Barang</label>
                    <div class="col-sm-4">
				...
				<div class="form-group">
                    ...
                    <div class="col-sm-4" id="item_subgroup_id2">
                      <select id="item_subgroup_id" name="item_subgroup_id" data-placeholder="..." class="chosen-select form-control" tabindex="2" style="width: auto" >
                        <option value=""></option>
                        <?php 
              ...
              <div class="form-group">
	                ...
	                <div class="col-sm-3">
	                  <input type="submit" name="submit" id="submit" class='btn btn-primary' value="Preview" onclick="submitForm('view')" /><?php /*&nbsp;&nbsp;<a href="JavaScript:excel_export()">
