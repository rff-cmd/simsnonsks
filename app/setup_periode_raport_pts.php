	...
	<div class="row">
		<div class="col-xs-12">
            ...
            <?php 
				...
				include("app/exec/insert_setup_periode_raport_pts.php");
				
				$aktif = "checked";
				
				if ($ref != "") {
					$sql=$select->list_setup_periode_raport_pts($ref);
			...
			<!-- PAGE CONTENT BEGINS -->
			<form class="form-horizontal" role="form" action="" method="post" name="setup_periode_raport2" id="setup_periode_raport2" class="form-horizontal" enctype="multipart/form-data" onSubmit="return cekinput('idtahunajaran,semester_id,tingkat_id,tanggal_ttd');" >
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<select name="tingkat_id" id="tingkat_id" class="chosen-select form-control" >
							<option value=""></option>
							<?php select_tingkat_unit("SMA", $setup_periode_raport_data->tingkat_id); ?>
						</select>								
					</div>
				</div>
				...
				<div class="clearfix form-actions">
					<div class="col-md-offset-3 col-md-9">
                        ...
                        <?php if (allowadd('frmsetup_periode_raport_pts')==1) { ?>
    						<?php if($ref=='') { ?>
						...
						&nbsp;
						<input type="button" name="submit" id="submit" class="btn btn-success" value="List Data" onclick="self.location='<?php echo $nama_folder . '/' . obraxabrix('setup_periode_raport_pts_view') ?>'" />
