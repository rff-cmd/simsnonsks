...
<div class="page-content">
	...
	<div class="row">
		<div class="col-xs-12">
			...
			<!-- PAGE CONTENT BEGINS -->
			<form class="form-horizontal" role="form" action="" method="post" name="siswa_krs" id="siswa_krs" class="form-horizontal" enctype="multipart/form-data" onSubmit="return cekinput('nis,semester_id');" >
            	
            	<input type="hidden" id="id" name="id" value="<?php echo $ref ?>" >
            	<input type="hidden" id="idtahunajaran" name="idtahunajaran" value="<?php echo $_SESSION['idtahunajaran'] ?>" >
            	
            	<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Tahun Ajaran</label>
					<div class="col-sm-3">
						<select name="idtahunajaran1" id="idtahunajaran1" disabled="" class="chosen-select form-control" >
							<option value=""></option>
							<?php select_thnajaran($_SESSION['idtahunajaran']); ?>
						</select>
					</div>
				</div>
            	...
            	<div class="form-group">
					...
					<div class="col-sm-4">
						<?php if($_SESSION["adm"] == 1 && $_SESSION["tipe_user"] != "Siswa") { ?>
							<select name="nis" id="nis" class="chosen-select form-control" onchange="loadHTMLPost2('app/siswa_krs_ajax.php','siswa_krs_pelajaran','getkrs','nis','semester_id')" >
								<option value=""></option>
								<?php select_siswa_all($nis); ?>
							</select>
						<?php } else if ( $_SESSION["tipe_user"] == "Guru") { ?>
							<select name="nis" id="nis" class="chosen-select form-control" onchange="loadHTMLPost2('app/siswa_krs_ajax.php','siswa_krs_pelajaran','getkrs','nis','semester_id')" >
								<option value=""></option>
								<?php select_siswa_all($nis); ?>
							</select>
						<?php } else if($_SESSION["adm"] == 0 && $_SESSION["tipe_user"] == "Siswa") { ?>
							<select name="nis1" id="nis1" disabled="" class="chosen-select form-control" >
								<option value=""></option>
								<?php select_siswa_all($nis); ?>
							</select>
            	...
            	<div id="siswa_krs_pelajaran">
            		<?php 
            			...
            			if( !empty($ref) ) {
							...
							include("siswa_krs_pelajaran_update.php");
						}
            		?>
            	</div>
