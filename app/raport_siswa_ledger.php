					...
					<form class="form-horizontal" role="form" action="" method="post" name="siswa_list" id="siswa_list" enctype="multipart/form-data" >
		            	...
		            	<div class="form-group">
							...
							<div class="col-lg-2">
								...
								<input type="checkbox" name="semester_id" id="semester_id" class="ace" value="1"><span class="lbl">Semester 1</span>&nbsp;
								<input type="checkbox" name="semester_id1" id="semester_id1" class="ace" value="1"><span class="lbl">Semester 2</span>&nbsp;

								<br>
								<input type="checkbox" name="semester_id2" id="semester_id2" class="ace" value="1"><span class="lbl">Semester 3</span>&nbsp;
								<input type="checkbox" name="semester_id3" id="semester_id3" class="ace" value="1"><span class="lbl">Semester 4</span>&nbsp;

								<br>
								<input type="checkbox" name="semester_id4" id="semester_id4" class="ace" value="1"><span class="lbl">Semester 5</span>&nbsp;
								<input type="checkbox" name="semester_id5" id="semester_id5" class="ace" value="1"><span class="lbl">Semester 6</span>
							</div>
						</div>
