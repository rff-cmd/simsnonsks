		...
		<div class="col-xs-12">
            ...
            <?php 
				...
				if ($ref != "") {
					...
					$row_tahunbuku=$sql->fetch(PDO::FETCH_OBJ);	
					
					$tanggalmulai = date("d-m-Y", strtotime($row_tahunbuku->tanggalmulai));
					if ($row_tahunbuku->aktif == 1) {
						$aktif = "checked";
					} else {
						$aktif = "";
					}
			...
			<!-- PAGE CONTENT BEGINS -->
			<form class="form-horizontal" role="form" action="" method="post" name="tahunbuku" id="tahunbuku" class="form-horizontal" enctype="multipart/form-data" onSubmit="return cekinput('tahunbuku,tanggalmulai');" >
            	...
            	<div class="form-group">
					...
					<div class="col-sm-3">
						<input type="text" id="tahunbuku" name="tahunbuku" class="form-control" value="<?php echo $row_tahunbuku->tahunbuku ?>">
					</div>
				</div>
                ...
                <div class="form-group">
					...
					<div class="col-lg-2">
						<input type="text" id="tanggalmulai" name="tanggalmulai" class="form-control date-picker" data-date-format="dd-mm-yyyy" value="<?php echo $tanggalmulai ?>">
					</div>
				</div>
                
                <div class="form-group">
					<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Awalan Kuitansi</label>
					<div class="col-sm-3">
						<input type="text" id="awalan" name="awalan" class="form-control" value="<?php echo $row_tahunbuku->awalan ?>">
					</div>
				</div>
                ...
                <div class="form-group">
					...
					<div class="col-sm-3">
						<textarea id="keterangan" name="keterangan" class="form-control"><?php echo $row_tahunbuku->keterangan ?></textarea>
					</div>
				</div>
