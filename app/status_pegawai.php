		...
		<div class="col-xs-12">
            ...
            <?php 
				...
				if ($ref != "") {
					...
					$row_status_pegawai=$sql->fetch(PDO::FETCH_OBJ);	
					
					if ($row_status_pegawai->aktif == 1) {
						$act = "checked";
					} else {
						$act = "";
					}
			...
			<!-- PAGE CONTENT BEGINS -->
			<form class="form-horizontal" role="form" action="" method="post" name="status_pegawai2" id="status_pegawai2" class="form-horizontal" enctype="multipart/form-data" onSubmit="return cekinput('nama');" >
            	...
            	<div class="form-group">
					...
					<div class="col-sm-3">
						<input type="text" id="nama" name="nama" class="form-control" value="<?php echo $row_status_pegawai->nama ?>">
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						...
						<?php } else { ?>
							<input class="ace" type="checkbox" name="aktif" id="aktif" value="1" <?php if($row_status_pegawai->aktif==1) echo "checked";?>/>
						<?php } ?>
						<span class="lbl"></span>
