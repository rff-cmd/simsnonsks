...
<div class="page-content">
	...
	<div class="row">
		<div class="col-xs-12">
			...
			<!-- PAGE CONTENT BEGINS -->
			<form class="form-horizontal" role="form" action="" method="post" name="konfigurasi" id="konfigurasi" class="form-horizontal" enctype="multipart/form-data" onSubmit="return cekinput('konfigurasi');" >
            	
            	<input type="hidden" id="id" name="id" value="<?php echo $ref ?>" >
            	<input type="hidden" id="departemen" name="departemen" value="SMA" >
                    	
            	<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Max. Pinjam Siswa</label>
					<div class="col-sm-3">
						<input type="text" name="siswa" id="siswa" onkeyup="formatangka('siswa')" class="form-control" value="<?php echo $siswa ?>">
					</div>
				</div>
				
                <div class="form-group">
					<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Max. Pinjam Pegawai</label>
					<div class="col-sm-3">
						<input type="text" name="pegawai" id="pegawai" onkeyup="formatangka('pegawai')" class="form-control" value="<?php echo $pegawai ?>">
					</div>
				</div>
				
				<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Max. Luar Sekolah</label>
					<div class="col-sm-3">
						<input type="text" name="other" id="other" onkeyup="formatangka('other')" class="form-control" value="<?php echo $other ?>">
					</div>
				</div>
				
				<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Denda (per hari)</label>
					<div class="col-sm-3">
						<input type="text" name="denda" id="denda" onkeyup="formatangka('denda')" class="form-control" value="<?php echo $denda ?>">
					</div>
				</div>
