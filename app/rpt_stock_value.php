...
<script language="javascript">
	function submitForm(tipe)
    {
		if(tipe == 'view') {
			...
			$("#rpt_stock").attr('action', 'app/rpt_stock_value_view.php')
			   .attr('target', '_BLANK');
			$("#rpt_stock").submit();
		}
		...
		if(tipe == 'label') {
			//document.getElementById("delord_view").action = "app/delord_print.php";
			$("#rpt_stock").attr('action', 'app/rpt_stock_value_harga.php')
			   .attr('target', '_BLANK');
			$("#rpt_stock").submit();
		}
...
<script type="text/javascript">
	function excel_export() {
		...
		document.location.href = "app/rpt_stock_value_xls.php?item_code="+item_code+"&location_id="+location_id+"&uom_code="+uom_code+"&date_from="+date_from+"&date_to="+date_to+"&all="+all+"&item_group_id="+item_group_id;	
	}
</script>
		...
		<div class="col-xs-12">
			...
			<form class="form-horizontal" role="form" action="" method="post" name="rpt_stock" id="rpt_stock" class="form-horizontal" enctype="multipart/form-data" >
				...
				<div class="form-group">
                    ...
                    <div class="col-lg-4">
                      <input type="text" id="date_from" name="date_from" class="form-control date-picker" data-date-format="dd-mm-yyyy" value="<?php echo $date_from ?>">
					</div>
				</div>
				
				<div class="form-group">
                    <label class="col-sm-3 control-label no-padding-right">s/d Tanggal</label>
                    <div class="col-lg-4">
                      <input type="text" id="date_to" name="date_to" class="form-control date-picker" data-date-format="dd-mm-yyyy" value="<?php echo $date_to ?>">
					</div>
				</div>
              ...
              <div class="form-group">
	                ...
	                <div class="col-sm-3">
	                  <input type="submit" name="submit" id="submit" class='btn btn-primary' value="Preview" onclick="submitForm('view')" />&nbsp;&nbsp;
