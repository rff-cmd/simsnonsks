<tbody>
	<tr>
		<th colspan="11">Kelompok B (Umum)</th>
	</tr>
	<?php
		//$sql=$selectview->list_siswa_krs($datasiswa->nis, 2);
	...
	<tr>
		...
		<input type="hidden" name="kelompok_pelajaran_<?php echo $no ?>" id="kelompok_pelajaran_<?php echo $no ?>" class="form-control" value="2">
	</tr>
	<?php
			$no++;
		}
