...
<div class="page-content">		
		...
		<div class="col-xs-12">
			...
			<form class="form-horizontal" role="form" action="" method="post" name="set_item_price" id="set_item_price" class="form-horizontal" enctype="multipart/form-data" >
            	...
            	<div class="form-group">
					...
					<div class="col-lg-3">
						<input type="text" id="code" name="code" autocomplete="off" class="form-control" oninput="loadHTMLPost2('app/set_item_price_ajax.php','item_name','getitem','code')" autofocus="" value="<?php echo $code ?>">
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-lg-3">
						<input type="text" id="old_code" name="old_code" class="form-control" oninput="loadHTMLPost2('app/set_item_price_ajax.php','item_name','getitem','old_code')" value="<?php echo $old_code ?>">
					</div>
				</div>
	...
	<?php 
		if( $code != "" || $old_code != "" || $name != "" || $item_group_id != "" ) {
			include("set_item_price_update.php");
		}
