...
<script language="javascript">
	function print() {
		...
		window.open('<?php echo $__folder ?>app/payment_print.php?ref='+ref, 'Pembayaran Print','825','450','resizable=1,scrollbars=1,status=0,toolbar=0')
	}
			...
			<form class="form-horizontal" action="" method="post" name="payment" id="payment" enctype="multipart/form-data" onSubmit="return cekinput('ref,date,payment_type');" >	
				...
				<div class="clearfix form-actions">
					<div class="col-md-offset-3 col-md-9">
						...
						<input type="button" name="submit" id="submit" class="btn btn-success" value="List Data" onclick="self.location='<?php echo $nama_folder . '/' . obraxabrix('payment_view') ?>'" />
