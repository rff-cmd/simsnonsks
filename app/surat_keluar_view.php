								...
								?>
                                        ...
                                        <tr>
											...
											<?php if (allowupd('frmsurat_masuk')==1) { ?>
												<a class="blue" href="/sman28/app/surat_keluar_preview.php?ref=<?php echo $surat_keluar_view->ref ?>" target="_blank" title="Preview"><?php $surat_keluar_view->file_dokumen; ?>
													<i class="fa fa-eye "></i>
												</a>
											<?php } ?>
											...
											<?php if (allowdel('frmsurat_masuk')==1) { ?>    
												&nbsp;
												<a class="green" href="/sman28/app/surat_keluar_download.php?ref=<?php echo $surat_keluar_view->ref ?>" target="_blank" title="Download"><?php $surat_keluar_view->file_dokumen; ?>
